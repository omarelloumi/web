                                    ...
                                    <div class="first-row form-group">
                                       ...
                                       <div class="card_number_grids">
                                          <div class="card_number_grid_left">
                                             <div class="controls">
                                                <label name="number"  value="number" class="control-label">Mobile number:</label>
                                       ...
                                       <div class="controls">
                                          <label name="adresse" class="control-label">Address type: </label>
                                          <input name="adresse" class="form-control" type="text" placeholder="adresse">
                                       </div>
									   <div class="controls">
                                          <label name="ref" class="control-label">Reference de la commande: </label>
                                          <input name="ref" class="form-control" type="text" placeholder="reference">
                                       </div>
									   </div>
									   <div class="controls">
                                          <label name="datel" class="control-label">Date de livraison: </label>
                                          <input name="datel" class="form-control" type="text" value="<?php echo $date=date('y-m-d', strtotime('+7 day')); ?>">
                                       </div>
                                    </div>
									 
									
                                    <button class="submit check_out" onclick="test()">Delivery to this Address</button>
