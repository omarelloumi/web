...
<head>
	<script language="javascript" src="varifajouterp.js"></script>
  <meta charset="utf-8">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
		...
		<form name="f" action="ajouterproduit.php" method="get">
<div class="form-label-group">
		<h4>Référence de produit: </h4>
	
              <input name = "ref" type="text"  class="form-control"  required="required" autofocus="autofocus">
		<h4>Nom de produit: </h4>
              <input name = "nom" type="text"  class="form-control"  required="required" >
